...
BASE=0
python $PYTHON_PARSER -r $OUTPUT_FILES_SUFIX -d $OUTPUT_DIRECTORY -f $FLAGS_FILE -o $OUTPUT_DIRECTORY/$OUTPUT_CVS_FILENAME -b $OUTPUT_DIRECTORY/$OUTPUT_FILES_SUFIX$BASE
